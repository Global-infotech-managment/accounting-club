...
const OnlineCourse = () => {
  ...
  return (
    <div className="relative" id="course-info">
      <div className="container relative z-20 my-16 px-3 md:my-24 lg:my-[120px] lg:max-w-[1184px]">
        <Heading
      ...
      <img
        className="pointer-events-none absolute -top-[155px] right-0 z-0 max-sm:-top-20 max-sm:w-[150px]"
        src={OnlineBook}
        alt="online book"
      />
    </div>
