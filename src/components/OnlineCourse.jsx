...
const OnlineCourse = () => {
    ...
    return (
        <div>
            <div className="container lg:max-w-[1184px] px-3 my-16 md:my-24 lg:my-[120px]">
                ...
                <Swiper onSlideChange={(swiper) => setActiveIndex(swiper.activeIndex)}
                    ...
                    {onlineCourse.map((obj, index) => (
                        <SwiperSlide key={index}>
                            <div className="border border-black border-opacity-5 rounded-5 p-4 sm:p-6 max-sm:min-h-[208px] md:min-h-[231px] lg:min-h-[246px] xl:min-h-[224px]">
