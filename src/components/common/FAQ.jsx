...
import leftLinear from '../../assets/images/png/courses-right-linear.png'
import rightLinear from '../../assets/images/png/faq-left-linear.png'
const FAQ = () => {
  return (
    <div className="relative">
      <img
        src={leftLinear}
        alt="leftLinear"
        className="pointer-events-none absolute start-0 top-0 -z-10 max-h-[370px] w-full max-w-[120px]"
      />
      <img
        src={leftLinear}
        alt="leftLinear"
        className="pointer-events-none absolute start-0 bottom-[-30%] -z-10 max-h-[370px] w-full max-w-[120px]"
      />
      <img
        src={rightLinear}
        alt="leftLinear"
        className="pointer-events-none absolute end-0 top-0 -z-10 max-h-[370px] w-full max-w-[120px]"
      />
      <div className="container mt-[50px] w-full px-3 sm:mt-16 lg:mt-[110px] lg:max-w-[1184px]">
        <p className="lg:mb-4 mb-2 text-center text-[28px] font-bold leading-tight text-black sm:text-[35px] md:text-[40px] lg:text-[48px]">
          Frequently Asked <span className="text-gradient">Questions</span>
        </p>
        <p className="mx-auto max-w-[611px] text-center text-[14px] font-normal text-black md:text-[16px]">
          Clear and Concise Answers to Common Queries for Better Understanding
